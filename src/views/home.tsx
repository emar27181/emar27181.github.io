...
export function Home() {
  ...
  return (
    <div>
      ...
      {/*レスポンシブデザインに対応していないため、スマートフォンでは上手く表示されないことがあります。<br />*/}
      このサイトのGitHubリポジトリは
				<a className='link' target='_blank' href='https://github.com/emar27181/emar27181.github.io'>
					こちら
				</a>
				からご覧いただけます。
      <br />
      ...
      <h3>外部リンク</h3>
      <a href="https://emar27181-resume.netlify.app/" target="_blank">Portfolio</a><br />
